        ...
        <section id="ceremony" className="min-h-screen flex items-center py-20 bg-[var(--background)] transition-colors duration-300 relative">
            ...
            <div className="container mx-auto px-4 text-center z-10 relative">
                ...
                <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Casamento%20Sarah%20%26%20Nelson&dates=20260822T140000Z/20260823T030000Z&details=Celebra%C3%A7%C3%A3o%20do%20nosso%20casamento!%20Esperamos%20voc%C3%AA%20para%20celebrar%20conosco.&location=S%C3%ADtio%20S%C3%B3%20no%20C%C3%A9u%20-%20Santa%20Teresa%2C%20ES"
                    ...
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="bg-[var(--card-bg)] p-10 shadow-sm border border-seal-blue/20 transition-colors duration-300"
                    >
                        <div className="w-16 h-16 bg-seal-blue/10 rounded-full flex items-center justify-center mx-auto mb-6 text-seal-blue">
                            <Clock size={32} />
                        </div>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-6 inline-flex items-center gap-2 text-seal-blue hover:text-[var(--text-primary)] transition-colors font-medium border border-seal-blue/30 px-4 py-2 rounded-sm text-sm"
                        >
                            <Calendar size={16} />
                            Adicionar à Agenda
                        </a>
                    ...
                    <a href="https://maps.app.goo.gl/83CpDWFnYuHJ6FwZ6" target="_blank" className="inline-block mt-4 text-sm text-seal-blue border-seal-blue hover:text-[var(--text-primary)] transition-colors">
                        <motion.div
                            whileHover={{ y: -5 }}
                            className="bg-[var(--card-bg)] p-10 shadow-sm border border-seal-blue/20 transition-colors duration-300"
                        >
                            ...
                            <div className="mt-4 inline-flex items-center gap-2 text-seal-blue font-medium">
                                Ver Mapa
                            </div>
                        </motion.div>
                    </a>
